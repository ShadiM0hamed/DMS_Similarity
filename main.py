...
crisis_list = get_similar_crisis_list("health")
similar_crisis, similarity_confidence =  get_similar(sentence= "Some young men died at sea", sentence_space= crisis_list)
action = get_action(similar_crisis, "health")
